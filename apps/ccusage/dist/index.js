#!/usr/bin/env node
import { $ as DEFAULT_REFRESH_INTERVAL_SECONDS, B as pushBreakdownRows, D as calculateBurnRate, E as DEFAULT_SESSION_DURATION_HOURS, F as formatDateCompact, G as BLOCKS_COMPACT_WIDTH_THRESHOLD, H as getFileModifiedTime, I as formatModelsDisplayMultiline, K as BLOCKS_DEFAULT_TERMINAL_WIDTH, L as formatNumber, M as addEmptySeparatorRow, N as createUsageReportTable, O as filterRecentBlocks, P as formatCurrency, Q as DEFAULT_RECENT_DAYS, R as formatTotalsRow, U as unreachable, V as require_picocolors, W as _usingCtx, Y as CONFIG_FILE_NAME, Z as DEFAULT_LOCALE, _ as loadWeeklyUsageData, at as pipe, ct as inspect, dt as isFailure, f as loadDailyUsageData, ft as toArray, g as loadSessionUsageById, h as loadSessionData, it as try_, j as ResponsiveTable, k as projectBlockUsage, lt as succeed, m as loadSessionBlockData, ot as map$1, p as loadMonthlyUsageData, pt as __toESM, q as BLOCKS_WARNING_THRESHOLD, rt as unwrap, s as getClaudePaths, st as inspectError, tt as WEEK_DAYS, ut as isSuccess, z as formatUsageDataRow } from "./data-loader-DYj8oFeR.js";
import { M as getTotalTokens, O as parse$1, d as filterDateSchema, k as safeParse, n as SortOrders, t as CostModes, w as flatten, y as statuslineHookJsonSchema } from "./_types-CN00lEae.js";
import { n as createTotalsObject, t as calculateTotals } from "./calculate-cost-BGvo5v0s.js";
import { a as version, i as name, n as logger, r as description, t as log } from "./logger-CCLoO8UB.js";
import { n as printMismatchReport, t as detectMismatches } from "./debug-CZs24UEZ.js";
			...
			try: async () => {
				...
				const { blockInfo, burnRateInfo } = await pipe(try_({
					...
					if (activeBlock != null) {
						...
						const blockInfo$1 = `${formatCurrency(blockCost)} (${formatRemainingTime(remaining)})`;
